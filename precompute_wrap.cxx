...
#define SWIGTYPE_p_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t swig_types[6]
#define SWIGTYPE_p_std__allocatorT_unsigned_int_t swig_types[7]
...
#define SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t swig_types[10]
#define SWIGTYPE_p_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t swig_types[11]
...
/*-----------------------------------------------
              @(target):= _Diffusion.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__Diffusion

#else
#  define SWIG_init    init_Diffusion

#endif
#define SWIG_name    "_Diffusion"
...
#include "precompute/diffusion.h"
...
SWIGINTERN swig::SwigPyIterator *std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__iterator(std::vector< std::vector< unsigned int > > *self,PyObject **PYTHON_SELF){
      return swig::make_output_iterator(self->begin(), self->begin(), self->end(), *PYTHON_SELF);
    }
SWIGINTERN bool std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____nonzero__(std::vector< std::vector< unsigned int > > const *self){
      return !(self->empty());
    }
SWIGINTERN bool std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____bool__(std::vector< std::vector< unsigned int > > const *self){
      return !(self->empty());
    }
SWIGINTERN std::vector< std::vector< unsigned int > >::size_type std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____len__(std::vector< std::vector< unsigned int > > const *self){
      return self->size();
    }
SWIGINTERN std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > *std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____getslice__(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::difference_type i,std::vector< std::vector< unsigned int > >::difference_type j){
      return swig::getslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setslice____SWIG_0(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::difference_type i,std::vector< std::vector< unsigned int > >::difference_type j){
...
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setslice____SWIG_1(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::difference_type i,std::vector< std::vector< unsigned int > >::difference_type j,std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &v){
      swig::setslice(self, i, j, 1, v);
    }
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____delslice__(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::difference_type i,std::vector< std::vector< unsigned int > >::difference_type j){
      swig::delslice(self, i, j, 1);
    }
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____delitem____SWIG_0(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::difference_type i){
      swig::erase(self, swig::getpos(self, i));
    }
SWIGINTERN std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > *std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____getitem____SWIG_0(std::vector< std::vector< unsigned int > > *self,SWIGPY_SLICEOBJECT *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return NULL;
...
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setitem____SWIG_0(std::vector< std::vector< unsigned int > > *self,SWIGPY_SLICEOBJECT *slice,std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &v){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setitem____SWIG_1(std::vector< std::vector< unsigned int > > *self,SWIGPY_SLICEOBJECT *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____delitem____SWIG_1(std::vector< std::vector< unsigned int > > *self,SWIGPY_SLICEOBJECT *slice){
      Py_ssize_t i, j, step;
      if( !PySlice_Check(slice) ) {
        SWIG_Error(SWIG_TypeError, "Slice object expected.");
        return;
...
SWIGINTERN std::vector< std::vector< unsigned int > >::value_type const &std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____getitem____SWIG_1(std::vector< std::vector< unsigned int > > const *self,std::vector< std::vector< unsigned int > >::difference_type i){
      return *(swig::cgetpos(self, i));
    }
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setitem____SWIG_2(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::difference_type i,std::vector< std::vector< unsigned int > >::value_type const &x){
      *(swig::getpos(self,i)) = x;
    }
SWIGINTERN std::vector< std::vector< unsigned int > >::value_type std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__pop(std::vector< std::vector< unsigned int > > *self){
      if (self->size() == 0)
	throw std::out_of_range("pop from empty container");
...
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__append(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::value_type const &x){
      self->push_back(x);
    }
SWIGINTERN std::vector< std::vector< unsigned int > >::iterator std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__erase__SWIG_0(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::iterator pos){ return self->erase(pos); }
SWIGINTERN std::vector< std::vector< unsigned int > >::iterator std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__erase__SWIG_1(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::iterator first,std::vector< std::vector< unsigned int > >::iterator last){ return self->erase(first, last); }
SWIGINTERN std::vector< std::vector< unsigned int > >::iterator std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__insert__SWIG_0(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::iterator pos,std::vector< std::vector< unsigned int > >::value_type const &x){ return self->insert(pos, x); }
SWIGINTERN void std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__insert__SWIG_1(std::vector< std::vector< unsigned int > > *self,std::vector< std::vector< unsigned int > >::iterator pos,std::vector< std::vector< unsigned int > >::size_type n,std::vector< std::vector< unsigned int > >::value_type const &x){ self->insert(pos, n, x); }
#ifdef __cplusplus
extern "C" {
#endif
...
SWIGINTERN PyObject *_wrap_Diffusion(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > *arg1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "Diffusion", 7, 7, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Diffusion" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Diffusion" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > &""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_std__vectorT_double_std__allocatorT_double_t_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Diffusion" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Diffusion" "', argument " "2"" of type '" "std::vector< double,std::allocator< double > > &""'"); 
  }
  ...
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "Diffusion" "', argument " "3"" of type '" "std::vector< unsigned int,std::allocator< unsigned int > > &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Diffusion" "', argument " "3"" of type '" "std::vector< unsigned int,std::allocator< unsigned int > > &""'"); 
  }
  arg3 = reinterpret_cast< std::vector< unsigned int,std::allocator< unsigned int > > * >(argp3);
  ecode4 = SWIG_AsVal_double(swig_obj[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Diffusion" "', argument " "4"" of type '" "double""'");
  } 
  arg4 = static_cast< double >(val4);
  ecode5 = SWIG_AsVal_unsigned_SS_int(swig_obj[4], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "Diffusion" "', argument " "5"" of type '" "unsigned int""'");
  } 
  arg5 = static_cast< unsigned int >(val5);
  ecode6 = SWIG_AsVal_unsigned_SS_int(swig_obj[5], &val6);
  if (!SWIG_IsOK(ecode6)) {
    SWIG_exception_fail(SWIG_ArgError(ecode6), "in method '" "Diffusion" "', argument " "6"" of type '" "unsigned int""'");
  } 
  arg6 = static_cast< unsigned int >(val6);
  ecode7 = SWIG_AsVal_unsigned_SS_int(swig_obj[6], &val7);
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "Diffusion" "', argument " "7"" of type '" "unsigned int""'");
  } 
  arg7 = static_cast< unsigned int >(val7);
  result = (double)Diffusion(*arg1,*arg2,*arg3,arg4,arg5,arg6,arg7);
...
SWIGINTERN PyObject *_wrap_uintvector_iterator(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_uintvector___nonzero__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___bool__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___len__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___getslice__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___setslice____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::difference_type arg2 ;
  std::vector< unsigned int >::difference_type arg3 ;
...
SWIGINTERN PyObject *_wrap_uintvector___setslice____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::difference_type arg2 ;
  std::vector< unsigned int >::difference_type arg3 ;
...
SWIGINTERN PyObject *_wrap_uintvector___delslice__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::difference_type arg2 ;
  std::vector< unsigned int >::difference_type arg3 ;
...
SWIGINTERN PyObject *_wrap_uintvector___delitem____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::difference_type arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___getitem____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  ...
  arg1 = reinterpret_cast< std::vector< unsigned int > * >(argp1);
  {
    if (!PySlice_Check(swig_obj[1])) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintvector___getitem__" "', argument " "2"" of type '" "SWIGPY_SLICEOBJECT *""'");
    }
...
SWIGINTERN PyObject *_wrap_uintvector___setitem____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  std::vector< unsigned int,std::allocator< unsigned int > > *arg3 = 0 ;
  ...
  {
    if (!PySlice_Check(swig_obj[1])) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintvector___setitem__" "', argument " "2"" of type '" "SWIGPY_SLICEOBJECT *""'");
    }
    arg2 = (SWIGPY_SLICEOBJECT *) swig_obj[1];
  }
  {
...
SWIGINTERN PyObject *_wrap_uintvector___setitem____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___delitem____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  void *argp1 = 0 ;
  ...
  {
    if (!PySlice_Check(swig_obj[1])) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintvector___delitem__" "', argument " "2"" of type '" "SWIGPY_SLICEOBJECT *""'");
    }
    arg2 = (SWIGPY_SLICEOBJECT *) swig_obj[1];
  }
  try {
...
SWIGINTERN PyObject *_wrap_uintvector___getitem____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::difference_type arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector___setitem____SWIG_2(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::difference_type arg2 ;
...
SWIGINTERN PyObject *_wrap_uintvector_pop(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_append(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
...
SWIGINTERN PyObject *_wrap_new_uintvector__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_new_uintvector__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_uintvector_empty(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_size(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_swap(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_begin(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_end(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_rbegin(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_rend(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_clear(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_get_allocator(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_new_uintvector__SWIG_2(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_uintvector_pop_back(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_resize__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_erase__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_erase__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::iterator arg2 ;
...
SWIGINTERN PyObject *_wrap_new_uintvector__SWIG_3(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int >::size_type arg1 ;
  std::vector< unsigned int >::value_type *arg2 = 0 ;
  size_t val1 ;
...
SWIGINTERN PyObject *_wrap_uintvector_push_back(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_front(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_back(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_assign(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::size_type arg2 ;
  std::vector< unsigned int >::value_type *arg3 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_resize__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::size_type arg2 ;
  std::vector< unsigned int >::value_type *arg3 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_insert__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::iterator arg2 ;
  std::vector< unsigned int >::value_type *arg3 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_insert__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::iterator arg2 ;
...
SWIGINTERN PyObject *_wrap_uintvector_reserve(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  std::vector< unsigned int >::size_type arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintvector_capacity(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_delete_uintvector(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< unsigned int > *arg1 = (std::vector< unsigned int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_uintmat_iterator(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_iterator" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (swig::SwigPyIterator *)std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__iterator(arg1,arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_swig__SwigPyIterator, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_uintmat___nonzero__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___nonzero__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (bool)std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____nonzero__((std::vector< std::vector< unsigned int > > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_uintmat___bool__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___bool__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (bool)std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____bool__((std::vector< std::vector< unsigned int > > const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_uintmat___len__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___len__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____len__((std::vector< std::vector< unsigned int > > const *)arg1);
  resultobj = SWIG_From_size_t(static_cast< size_t >(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_uintmat___getslice__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  std::vector< std::vector< unsigned int > >::difference_type arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ptrdiff_t val2 ;
  int ecode2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat___getslice__", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___getslice__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat___getslice__" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "uintmat___getslice__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val3);
  try {
    result = (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > *)std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____getslice__(arg1,SWIG_STD_MOVE(arg2),SWIG_STD_MOVE(arg3));
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___setslice____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  std::vector< std::vector< unsigned int > >::difference_type arg3 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___setslice__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat___setslice__" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "uintmat___setslice__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val3);
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setslice____SWIG_0(arg1,SWIG_STD_MOVE(arg2),SWIG_STD_MOVE(arg3));
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___setslice____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  std::vector< std::vector< unsigned int > >::difference_type arg3 ;
  ...
  arg3 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val3);
  {
    ...
    res4 = swig::asptr(swig_obj[3], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "uintmat___setslice__" "', argument " "4"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat___setslice__" "', argument " "4"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &""'"); 
    }
    arg4 = ptr;
  }
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setslice____SWIG_1(arg1,SWIG_STD_MOVE(arg2),SWIG_STD_MOVE(arg3),(std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &)*arg4);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___setslice__(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[5] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat___setslice__", 0, 4, argv))) SWIG_fail;
  --argc;
  if (argc == 3) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    _v = SWIG_CheckState(res);
    if (_v) {
      {
        int res = SWIG_AsVal_ptrdiff_t(argv[1], NULL);
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_uintmat___setslice____SWIG_0(self, argc, argv);
        }
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          int res = swig::asptr(argv[3], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_uintmat___setslice____SWIG_1(self, argc, argv);
          }
        }
      }
    }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat___setslice__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::__setslice__(std::vector< std::vector< unsigned int > >::difference_type,std::vector< std::vector< unsigned int > >::difference_type)\n"
    "    std::vector< std::vector< unsigned int > >::__setslice__(std::vector< std::vector< unsigned int > >::difference_type,std::vector< std::vector< unsigned int > >::difference_type,std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat___delslice__(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  std::vector< std::vector< unsigned int > >::difference_type arg3 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat___delslice__", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___delslice__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat___delslice__" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val2);
  ecode3 = SWIG_AsVal_ptrdiff_t(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "uintmat___delslice__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg3 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val3);
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____delslice__(arg1,SWIG_STD_MOVE(arg2),SWIG_STD_MOVE(arg3));
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___delitem____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___delitem__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat___delitem__" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val2);
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____delitem____SWIG_0(arg1,SWIG_STD_MOVE(arg2));
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___getitem____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___getitem__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  {
    if (!PySlice_Check(swig_obj[1])) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat___getitem__" "', argument " "2"" of type '" "SWIGPY_SLICEOBJECT *""'");
    }
    arg2 = (SWIGPY_SLICEOBJECT *) swig_obj[1];
  }
  try {
    result = (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > *)std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____getitem____SWIG_0(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___setitem____SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___setitem__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  {
    if (!PySlice_Check(swig_obj[1])) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat___setitem__" "', argument " "2"" of type '" "SWIGPY_SLICEOBJECT *""'");
    }
    arg2 = (SWIGPY_SLICEOBJECT *) swig_obj[1];
  }
  {
    ...
    res3 = swig::asptr(swig_obj[2], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "uintmat___setitem__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat___setitem__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &""'"); 
    }
    arg3 = ptr;
  }
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setitem____SWIG_0(arg1,arg2,(std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___setitem____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  void *argp1 = 0 ;
  ...
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setitem____SWIG_1(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___delitem____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  SWIGPY_SLICEOBJECT *arg2 = (SWIGPY_SLICEOBJECT *) 0 ;
  void *argp1 = 0 ;
  ...
  {
    if (!PySlice_Check(swig_obj[1])) {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat___delitem__" "', argument " "2"" of type '" "SWIGPY_SLICEOBJECT *""'");
    }
    arg2 = (SWIGPY_SLICEOBJECT *) swig_obj[1];
  }
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____delitem____SWIG_1(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  } catch(std::invalid_argument &_e) {
    SWIG_exception_fail(SWIG_ValueError, (&_e)->what());
...
SWIGINTERN PyObject *_wrap_uintmat___delitem__(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat___delitem__", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_uintmat___delitem____SWIG_1(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_uintmat___delitem____SWIG_0(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat___delitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::__delitem__(std::vector< std::vector< unsigned int > >::difference_type)\n"
    "    std::vector< std::vector< unsigned int > >::__delitem__(SWIGPY_SLICEOBJECT *)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat___getitem____SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  void *argp1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat___getitem__" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_ptrdiff_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat___getitem__" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val2);
  try {
    result = (std::vector< std::vector< unsigned int > >::value_type *) &std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____getitem____SWIG_1((std::vector< std::vector< unsigned int > > const *)arg1,SWIG_STD_MOVE(arg2));
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  resultobj = swig::from(static_cast< std::vector< unsigned int,std::allocator< unsigned int > > >(*result));
  (void)swig::container_owner<swig::traits<std::vector< std::vector< unsigned int > >::value_type>::category>::back_reference(resultobj, swig_obj[0]);
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_uintmat___getitem__(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat___getitem__", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_uintmat___getitem____SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_uintmat___getitem____SWIG_1(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat___getitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::__getitem__(SWIGPY_SLICEOBJECT *)\n"
    "    std::vector< std::vector< unsigned int > >::__getitem__(std::vector< std::vector< unsigned int > >::difference_type) const\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat___setitem____SWIG_2(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::difference_type arg2 ;
  ...
  ecode2 = SWIG_AsVal_ptrdiff_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat___setitem__" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::difference_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::difference_type >(val2);
  {
    std::vector< unsigned int,std::allocator< unsigned int > > *ptr = (std::vector< unsigned int,std::allocator< unsigned int > > *)0;
    res3 = swig::asptr(swig_obj[2], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "uintmat___setitem__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat___setitem__" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg3 = ptr;
  }
  try {
    std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg____setitem____SWIG_2(arg1,SWIG_STD_MOVE(arg2),(std::vector< unsigned int,std::allocator< unsigned int > > const &)*arg3);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_uintmat___setitem__(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat___setitem__", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_uintmat___setitem____SWIG_1(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_uintmat___setitem____SWIG_0(self, argc, argv);
        }
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_uintmat___setitem____SWIG_2(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat___setitem__'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::__setitem__(SWIGPY_SLICEOBJECT *,std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > > const &)\n"
    "    std::vector< std::vector< unsigned int > >::__setitem__(SWIGPY_SLICEOBJECT *)\n"
    "    std::vector< std::vector< unsigned int > >::__setitem__(std::vector< std::vector< unsigned int > >::difference_type,std::vector< std::vector< unsigned int > >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat_pop(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_pop" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  try {
    result = std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__pop(arg1);
  } catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
  resultobj = swig::from(static_cast< std::vector< unsigned int,std::allocator< unsigned int > > >(result));
...
SWIGINTERN PyObject *_wrap_uintmat_append(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat_append", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_append" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  {
    std::vector< unsigned int,std::allocator< unsigned int > > *ptr = (std::vector< unsigned int,std::allocator< unsigned int > > *)0;
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "uintmat_append" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_append" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg2 = ptr;
  }
  std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__append(arg1,(std::vector< unsigned int,std::allocator< unsigned int > > const &)*arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_new_uintmat__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
  ...
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, SWIG_POINTER_NEW |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_new_uintmat__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  std::vector< std::vector< unsigned int > > *result = 0 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    res1 = swig::asptr(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_uintmat" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_uintmat" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > const &""'"); 
    }
    arg1 = ptr;
  }
  result = (std::vector< std::vector< unsigned int > > *)new std::vector< std::vector< unsigned int > >((std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > const &)*arg1);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, SWIG_POINTER_NEW |  0 );
  if (SWIG_IsNewObj(res1)) delete arg1;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_empty(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_empty" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
...
SWIGINTERN PyObject *_wrap_uintmat_size(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_size" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
...
SWIGINTERN PyObject *_wrap_uintmat_swap(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat_swap", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_swap" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "uintmat_swap" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_swap" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > &""'"); 
  }
  arg2 = reinterpret_cast< std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > * >(argp2);
  (arg1)->swap(*arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_begin(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::vector< std::vector< unsigned int > >::iterator result;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_begin" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (arg1)->begin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_uintmat_end(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_end" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (arg1)->end();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_uintmat_rbegin(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  PyObject *swig_obj[1] ;
  std::vector< std::vector< unsigned int > >::reverse_iterator result;
  
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_rbegin" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (arg1)->rbegin();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::reverse_iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_uintmat_rend(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_rend" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (arg1)->rend();
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::reverse_iterator & >(result)),
...
SWIGINTERN PyObject *_wrap_uintmat_clear(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_clear" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  (arg1)->clear();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_uintmat_get_allocator(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_get_allocator" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = ((std::vector< std::vector< unsigned int > > const *)arg1)->get_allocator();
  resultobj = SWIG_NewPointerObj((new std::vector< std::vector< unsigned int > >::allocator_type(result)), SWIGTYPE_p_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_new_uintmat__SWIG_2(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > >::size_type arg1 ;
  size_t val1 ;
  int ecode1 = 0 ;
  std::vector< std::vector< unsigned int > > *result = 0 ;
  ...
  ecode1 = SWIG_AsVal_size_t(swig_obj[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_uintmat" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > >::size_type""'");
  } 
  arg1 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val1);
...
SWIGINTERN PyObject *_wrap_uintmat_pop_back(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_pop_back" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  (arg1)->pop_back();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_uintmat_resize__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_resize" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat_resize" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::size_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val2);
  (arg1)->resize(arg2);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_erase__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::iterator arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_erase" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat_erase" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat_erase" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::iterator""'");
  ...
  result = std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__erase__SWIG_0(arg1,SWIG_STD_MOVE(arg2));
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_erase__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::iterator arg2 ;
  std::vector< std::vector< unsigned int > >::iterator arg3 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  res3 = SWIG_ConvertPtr(swig_obj[2], SWIG_as_voidptrptr(&iter3), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res3) || !iter3) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat_erase" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *>(iter3);
    if (iter_t) {
      arg3 = iter_t->get_current();
    } else {
      SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat_erase" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::iterator""'");
  ...
  result = std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__erase__SWIG_1(arg1,SWIG_STD_MOVE(arg2),SWIG_STD_MOVE(arg3));
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_erase(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat_erase", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    ...
    if (_v) {
      swig::SwigPyIterator *iter = 0;
      int res = SWIG_ConvertPtr(argv[1], SWIG_as_voidptrptr(&iter), swig::SwigPyIterator::descriptor(), 0);
      _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *>(iter) != 0));
      if (_v) {
        return _wrap_uintmat_erase__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = (SWIG_IsOK(res) && iter && (dynamic_cast<swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *>(iter) != 0));
        if (_v) {
          return _wrap_uintmat_erase__SWIG_1(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat_erase'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::erase(std::vector< std::vector< unsigned int > >::iterator)\n"
    "    std::vector< std::vector< unsigned int > >::erase(std::vector< std::vector< unsigned int > >::iterator,std::vector< std::vector< unsigned int > >::iterator)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_new_uintmat__SWIG_3(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > >::size_type arg1 ;
  std::vector< std::vector< unsigned int > >::value_type *arg2 = 0 ;
  size_t val1 ;
  ...
  arg1 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val1);
  {
    ...
    res2 = swig::asptr(swig_obj[1], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_uintmat" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_uintmat" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg2 = ptr;
  }
  result = (std::vector< std::vector< unsigned int > > *)new std::vector< std::vector< unsigned int > >(arg1,(std::vector< std::vector< unsigned int > >::value_type const &)*arg2);
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, SWIG_POINTER_NEW |  0 );
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_new_uintmat(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "new_uintmat", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 0) {
    return _wrap_new_uintmat__SWIG_0(self, argc, argv);
  }
  if (argc == 1) {
    int _v = 0;
    {
    ...
    if (_v) {
      return _wrap_new_uintmat__SWIG_2(self, argc, argv);
    }
  }
  if (argc == 1) {
    int _v = 0;
    ...
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_uintmat__SWIG_1(self, argc, argv);
    }
  }
  if (argc == 2) {
    int _v = 0;
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_new_uintmat__SWIG_3(self, argc, argv);
      }
    }
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'new_uintmat'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::vector()\n"
    "    std::vector< std::vector< unsigned int > >::vector(std::vector< std::vector< unsigned int,std::allocator< unsigned int > > > const &)\n"
    "    std::vector< std::vector< unsigned int > >::vector(std::vector< std::vector< unsigned int > >::size_type)\n"
    "    std::vector< std::vector< unsigned int > >::vector(std::vector< std::vector< unsigned int > >::size_type,std::vector< std::vector< unsigned int > >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat_push_back(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::value_type *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat_push_back", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_push_back" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  {
    std::vector< unsigned int,std::allocator< unsigned int > > *ptr = (std::vector< unsigned int,std::allocator< unsigned int > > *)0;
    res2 = swig::asptr(swig_obj[1], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "uintmat_push_back" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_push_back" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg2 = ptr;
  }
  (arg1)->push_back((std::vector< std::vector< unsigned int > >::value_type const &)*arg2);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res2)) delete arg2;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_front(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_front" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (std::vector< std::vector< unsigned int > >::value_type *) &((std::vector< std::vector< unsigned int > > const *)arg1)->front();
  resultobj = swig::from(static_cast< std::vector< unsigned int,std::allocator< unsigned int > > >(*result));
  (void)swig::container_owner<swig::traits<std::vector< std::vector< unsigned int > >::value_type>::category>::back_reference(resultobj, swig_obj[0]);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_back(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_back" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  result = (std::vector< std::vector< unsigned int > >::value_type *) &((std::vector< std::vector< unsigned int > > const *)arg1)->back();
  resultobj = swig::from(static_cast< std::vector< unsigned int,std::allocator< unsigned int > > >(*result));
  (void)swig::container_owner<swig::traits<std::vector< std::vector< unsigned int > >::value_type>::category>::back_reference(resultobj, swig_obj[0]);
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_assign(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::size_type arg2 ;
  std::vector< std::vector< unsigned int > >::value_type *arg3 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat_assign", 3, 3, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_assign" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat_assign" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::size_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val2);
  {
    std::vector< unsigned int,std::allocator< unsigned int > > *ptr = (std::vector< unsigned int,std::allocator< unsigned int > > *)0;
    res3 = swig::asptr(swig_obj[2], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "uintmat_assign" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_assign" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg3 = ptr;
  }
  (arg1)->assign(arg2,(std::vector< std::vector< unsigned int > >::value_type const &)*arg3);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res3)) delete arg3;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_resize__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::size_type arg2 ;
  std::vector< std::vector< unsigned int > >::value_type *arg3 = 0 ;
  ...
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val2);
  {
    ...
    res3 = swig::asptr(swig_obj[2], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "uintmat_resize" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_resize" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg3 = ptr;
  }
  (arg1)->resize(arg2,(std::vector< std::vector< unsigned int > >::value_type const &)*arg3);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res3)) delete arg3;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_resize(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[4] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat_resize", 0, 3, argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_uintmat_resize__SWIG_0(self, argc, argv);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_uintmat_resize__SWIG_1(self, argc, argv);
        }
      }
    }
  }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat_resize'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::resize(std::vector< std::vector< unsigned int > >::size_type)\n"
    "    std::vector< std::vector< unsigned int > >::resize(std::vector< std::vector< unsigned int > >::size_type,std::vector< std::vector< unsigned int > >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat_insert__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::iterator arg2 ;
  std::vector< std::vector< unsigned int > >::value_type *arg3 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_insert" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  res2 = SWIG_ConvertPtr(swig_obj[1], SWIG_as_voidptrptr(&iter2), swig::SwigPyIterator::descriptor(), 0);
  if (!SWIG_IsOK(res2) || !iter2) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_TypeError), "in method '" "uintmat_insert" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::iterator""'");
  } else {
    swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *iter_t = dynamic_cast<swig::SwigPyIterator_T<std::vector< std::vector< unsigned int > >::iterator > *>(iter2);
    if (iter_t) {
      arg2 = iter_t->get_current();
  ...
  }
  {
    ...
    res3 = swig::asptr(swig_obj[2], &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "uintmat_insert" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_insert" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg3 = ptr;
  }
  result = std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__insert__SWIG_0(arg1,SWIG_STD_MOVE(arg2),(std::vector< unsigned int,std::allocator< unsigned int > > const &)*arg3);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::vector< unsigned int > >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res3)) delete arg3;
  return resultobj;
...
SWIGINTERN PyObject *_wrap_uintmat_insert__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::iterator arg2 ;
  std::vector< std::vector< unsigned int > >::size_type arg3 ;
  std::vector< std::vector< unsigned int > >::value_type *arg4 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  swig::SwigPyIterator *iter2 = 0 ;
  int res2 ;
  ...
  ecode3 = SWIG_AsVal_size_t(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "uintmat_insert" "', argument " "3"" of type '" "std::vector< std::vector< unsigned int > >::size_type""'");
  } 
  arg3 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val3);
  {
    std::vector< unsigned int,std::allocator< unsigned int > > *ptr = (std::vector< unsigned int,std::allocator< unsigned int > > *)0;
    res4 = swig::asptr(swig_obj[3], &ptr);
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "uintmat_insert" "', argument " "4"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "uintmat_insert" "', argument " "4"" of type '" "std::vector< std::vector< unsigned int > >::value_type const &""'"); 
    }
    arg4 = ptr;
  }
  std_vector_Sl_std_vector_Sl_unsigned_SS_int_Sg__Sg__insert__SWIG_1(arg1,SWIG_STD_MOVE(arg2),SWIG_STD_MOVE(arg3),(std::vector< unsigned int,std::allocator< unsigned int > > const &)*arg4);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res4)) delete arg4;
  return resultobj;
fail:
...
SWIGINTERN PyObject *_wrap_uintmat_insert(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[5] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "uintmat_insert", 0, 4, argv))) SWIG_fail;
  --argc;
  if (argc == 3) {
    int _v = 0;
    int res = swig::asptr(argv[0], (std::vector< std::vector< unsigned int,std::allocator< unsigned int > >,std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > >**)(0));
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        _v = SWIG_CheckState(res);
        if (_v) {
          return _wrap_uintmat_insert__SWIG_0(self, argc, argv);
        }
      }
    }
  }
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          ...
          _v = SWIG_CheckState(res);
          if (_v) {
            return _wrap_uintmat_insert__SWIG_1(self, argc, argv);
          }
        }
      }
    }
...
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'uintmat_insert'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    std::vector< std::vector< unsigned int > >::insert(std::vector< std::vector< unsigned int > >::iterator,std::vector< std::vector< unsigned int > >::value_type const &)\n"
    "    std::vector< std::vector< unsigned int > >::insert(std::vector< std::vector< unsigned int > >::iterator,std::vector< std::vector< unsigned int > >::size_type,std::vector< std::vector< unsigned int > >::value_type const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_uintmat_reserve(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  std::vector< std::vector< unsigned int > >::size_type arg2 ;
  void *argp1 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "uintmat_reserve", 2, 2, swig_obj)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_reserve" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  ecode2 = SWIG_AsVal_size_t(swig_obj[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "uintmat_reserve" "', argument " "2"" of type '" "std::vector< std::vector< unsigned int > >::size_type""'");
  } 
  arg2 = static_cast< std::vector< std::vector< unsigned int > >::size_type >(val2);
  (arg1)->reserve(arg2);
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_uintmat_capacity(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "uintmat_capacity" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > const *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
...
SWIGINTERN PyObject *_wrap_delete_uintmat(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::vector< std::vector< unsigned int > > *arg1 = (std::vector< std::vector< unsigned int > > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!args) SWIG_fail;
  swig_obj[0] = args;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_uintmat" "', argument " "1"" of type '" "std::vector< std::vector< unsigned int > > *""'"); 
  }
  arg1 = reinterpret_cast< std::vector< std::vector< unsigned int > > * >(argp1);
  delete arg1;
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *uintmat_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_std__vectorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *uintmat_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "Diffusion", _wrap_Diffusion, METH_VARARGS, NULL},
	 ...
	 { "uintmat_iterator", _wrap_uintmat_iterator, METH_O, NULL},
	 { "uintmat___nonzero__", _wrap_uintmat___nonzero__, METH_O, NULL},
	 { "uintmat___bool__", _wrap_uintmat___bool__, METH_O, NULL},
	 { "uintmat___len__", _wrap_uintmat___len__, METH_O, NULL},
	 { "uintmat___getslice__", _wrap_uintmat___getslice__, METH_VARARGS, NULL},
	 { "uintmat___setslice__", _wrap_uintmat___setslice__, METH_VARARGS, NULL},
	 { "uintmat___delslice__", _wrap_uintmat___delslice__, METH_VARARGS, NULL},
	 { "uintmat___delitem__", _wrap_uintmat___delitem__, METH_VARARGS, NULL},
	 { "uintmat___getitem__", _wrap_uintmat___getitem__, METH_VARARGS, NULL},
	 { "uintmat___setitem__", _wrap_uintmat___setitem__, METH_VARARGS, NULL},
	 { "uintmat_pop", _wrap_uintmat_pop, METH_O, NULL},
	 { "uintmat_append", _wrap_uintmat_append, METH_VARARGS, NULL},
	 { "uintmat_empty", _wrap_uintmat_empty, METH_O, NULL},
	 { "uintmat_size", _wrap_uintmat_size, METH_O, NULL},
	 { "uintmat_swap", _wrap_uintmat_swap, METH_VARARGS, NULL},
	 { "uintmat_begin", _wrap_uintmat_begin, METH_O, NULL},
	 { "uintmat_end", _wrap_uintmat_end, METH_O, NULL},
	 { "uintmat_rbegin", _wrap_uintmat_rbegin, METH_O, NULL},
	 { "uintmat_rend", _wrap_uintmat_rend, METH_O, NULL},
	 { "uintmat_clear", _wrap_uintmat_clear, METH_O, NULL},
	 { "uintmat_get_allocator", _wrap_uintmat_get_allocator, METH_O, NULL},
	 { "uintmat_pop_back", _wrap_uintmat_pop_back, METH_O, NULL},
	 { "uintmat_erase", _wrap_uintmat_erase, METH_VARARGS, NULL},
	 { "new_uintmat", _wrap_new_uintmat, METH_VARARGS, NULL},
	 { "uintmat_push_back", _wrap_uintmat_push_back, METH_VARARGS, NULL},
	 { "uintmat_front", _wrap_uintmat_front, METH_O, NULL},
	 { "uintmat_back", _wrap_uintmat_back, METH_O, NULL},
	 { "uintmat_assign", _wrap_uintmat_assign, METH_VARARGS, NULL},
	 { "uintmat_resize", _wrap_uintmat_resize, METH_VARARGS, NULL},
	 { "uintmat_insert", _wrap_uintmat_insert, METH_VARARGS, NULL},
	 { "uintmat_reserve", _wrap_uintmat_reserve, METH_VARARGS, NULL},
	 { "uintmat_capacity", _wrap_uintmat_capacity, METH_O, NULL},
	 { "delete_uintmat", _wrap_delete_uintmat, METH_O, NULL},
	 { "uintmat_swigregister", uintmat_swigregister, METH_O, NULL},
	 { "uintmat_swiginit", uintmat_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t = {"_p_std__allocatorT_std__vectorT_unsigned_int_std__allocatorT_unsigned_int_t_t_t", "std::vector< std::vector< unsigned int > >::allocator_type *|std::allocator< std::vector< unsigned int,std::allocator< unsigned int > > > *", 0, 0, (void*)0, 0};
